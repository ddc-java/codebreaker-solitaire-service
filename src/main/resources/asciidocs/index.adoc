...
Codebreaker adheres as closely as possible to standard HTTP and REST conventions in its
use of HTTP verbs. The subset of HTTP verbs used in this API are as follows:
